# src/db_qdrant.py
"""
QdrantDB wrapper for storing and retrieving embeddings.
"""
...
class QdrantDB:
    """Handles document storage/retrieval in Qdrant Cloud."""
    ...
    def __init__(self, url: str, api_key: str, collection_name: str = "quickrag_collection", vector_size: int = 384):
        ...
        print(f"[QdrantDB] Collection '{self.collection_name}' ready with vector size {self.vector_size}")

    def upsert(self, docs: List[str], embeddings: np.ndarray, batch_size: int = 64):
        """Upsert docs + embeddings into Qdrant in batches."""
    ...
    def search(self, query_vector: np.ndarray, top_k: int = 5):
        """Search Qdrant for top-k most similar vectors."""
